...
from datasets.train.data.torch.argoverse_v1_dataset import ArgoverseV1Module
...
if __name__ == '__main__':
    ...
    parser.add_argument('--root', type=str, default='datasets/train/data/', required=True)
